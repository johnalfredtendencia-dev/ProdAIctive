...
export default function DashboardScreen() {
  ...
  const userName = (params.fullName as string) || 'User';
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: Theme.primary, justifyContent: 'center', alignItems: 'center' },
